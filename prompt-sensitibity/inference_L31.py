...
def get_history_fn(model_and_tokenizer, prefix, history_size):
    
    model, tokenizer = model_and_tokenizer


    prefix_tokenized = tokenizer( prefix, return_tensors='pt').to('cuda')
...
def predict_fn(data, model_and_tokenizer, history = None):
