...
if __name__ ==  '__main__':
    ...
    with open(f'{train_file_name}-icl-adj.pickle', 'rb') as handle:
    ...
    for i, (train_index, test_index) in enumerate(skf.split(train['text'], train['Class'])):
        ...
        _ = train_model_dev(data_train=train.iloc[train_index], data_dev= train.iloc[test_index], epoches=250, batch_size=128,
    ...
    import pickle
    with open('../tsnh/Mc.pickle-icl-adj.pickle', 'wb') as handle:
